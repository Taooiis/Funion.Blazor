...
namespace FunionBlazor.Core.Entitys
{
    ...
    public class SysSettings : Entity, IEntitySeedData<SysSettings>
    {
        ...
        public IEnumerable<SysSettings> HasData(DbContext dbContext, Type dbContextLocator)
        {
            ...
            {
                new SysSettings { Id = 1, Name = "轨道衡测点",AttributeName="GdhStation",CPZOrder=2,GDHOrder=2},
                new SysSettings { Id = 2, Name = "车号",AttributeName="WagonNumber",CPZOrder=3,GDHOrder=3},
                new SysSettings { Id = 3, Name = "车型",AttributeName="MotorcycleType",CPZOrder=4,GDHOrder=4},
                new SysSettings { Id = 4, Name = "毛重", AttributeName="RoughWeight", CPZOrder=5,  GDHOrder=5 },
                new SysSettings { Id = 5, Name = "皮重", AttributeName="Tare", CPZOrder=6,  GDHOrder=6},
                new SysSettings { Id = 6, Name = "净重", AttributeName="Suttle", CPZOrder=7,  GDHOrder=7},
                ...
                new SysSettings { Id = 11, Name = "货名", AttributeName="CargoName", CPZOrder=11,  GDHOrder=11},
                new SysSettings { Id = 12, Name = "发货单位", AttributeName="TransceiverSend", CPZOrder=12,  GDHOrder=12},
                new SysSettings { Id = 13, Name = "收货单位", AttributeName="TransceiverCollect", CPZOrder=13,  GDHOrder=13},
                new SysSettings { Id = 14, Name = "发站", AttributeName="SendSend", CPZOrder=14,  GDHOrder=14},
                new SysSettings { Id = 15, Name = "到站", AttributeName="SendCollect", CPZOrder=15,  GDHOrder=15},
                ...
                new SysSettings { Id = 34, Name = "发站时间", AttributeName="StarCreateDatestr", CPZOrder=16,  GDHOrder=16},
                new SysSettings { Id = 35, Name = "时间", AttributeName="CreateDatestr", CPZOrder=1,  GDHOrder=1},
                new SysSettings { Id = 36, Name = "备注", AttributeName="Remark", CPZOrder=17,  GDHOrder=17},
            };
        }
    }
}
